...
public class CustomerRepositoryImpl2 implements CustomerRepository {
    ...
    public CustomerRepositoryImpl2() {
        ...
        customer.setEmail("lee1@test.com");
        customers.add(customer);
        Customer customer1 = new Customer();
        customer1.setId(2);
        customer1.setName("이이");
        customer1.setAddress("부산시");
        customer1.setEmail("lee2@test.com");
        customers.add(customer1);
        Customer customer2 = new Customer();
        customer2.setId(3);
        customer2.setName("이삼");
        customer2.setAddress("인천시");
        customer2.setEmail("lee3@test.com");
        customers.add(customer2);
        Customer customer3 = new Customer();
        customer3.setId(4);
        customer3.setName("이사");
        customer3.setAddress("대전시");
        customer3.setEmail("lee4@test.com");
        customers.add(customer3);
        Customer customer4 = new Customer();
        customer4.setId(4);
        customer4.setName("이오");
        customer4.setAddress("광주시");
        customer4.setEmail("lee5@test.com");
